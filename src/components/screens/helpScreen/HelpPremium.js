            ...
            <View style={styles.container}>
                ...
                <ScrollView>
                    ...
                    <View style={{justifyContent:"center",alignItems:"center",marginTop:25}}>
                        ...
                        <Image
                            style={{width: 55, height: 80,marginTop:-5,marginLeft:5}}
                            source={require('../../../../assets/images/tagpremium.png')}
                        />
                        <Text style={{marginTop:10,fontFamily: 'FuturaStd-Bold',fontSize:22,textAlign:"center"}}>Premium account</Text>
                        ...
                        <View style={{marginTop:20}}>
                            <Image
                                style={{width: 180, height: 100,marginTop:5}}
                                source={require('../../../../assets/images/perday.png')}
                            />
                        </View>
                        <Text style={{marginTop:20,fontFamily: 'FuturaStd-Bold',fontSize:25,color:"#000",textAlign:"center"}}>$ 9.99</Text>
